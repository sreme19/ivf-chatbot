...
import { UI_STRINGS, DEFAULT_LANGUAGE } from '@/lib/i18n'

export default function EmergencyBanner({ clinicPhone, clinicWhatsApp, language }: EmergencyBannerProps) {
  const t = UI_STRINGS[language ?? DEFAULT_LANGUAGE]
  return (
    <div
      role="alert"
      aria-live="assertive"
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="text-red-800 font-semibold text-base mb-1">{t.emergencyTitle}</h3>
          <p className="text-red-700 text-sm mb-3">{t.emergencyBody}</p>
          <div className="flex gap-2 flex-wrap">
            <a
              ...
              aria-label={`${t.callNow} ${clinicPhone}`}
            >
